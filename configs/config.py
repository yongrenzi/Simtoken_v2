...
parser.add_argument("--vision_pretrained",type=str,default='/home/oip/file/lbh/sam_vit_h_4b8939.pth')
parser.add_argument("--vision_tower",type=str,default='/home/oip/file/lbh/clip-vit-large-patch14')
parser.add_argument("--mllm",type=str,default='/home/oip/file/lbh/Chat-UniVi-7B-v1.5')
...
parser.add_argument("--name",type=str,default='testrun_baseline')
# path to ref-avs dataset
parser.add_argument("--data_dir",type=str,default='/home/oip/file/lyj/REFAVS',help=f"The data paranet dir. File arch should be: {file_arch}")
...
parser.add_argument("--checkpoint_root",type=str,default='/home/oip/file/lyj/checkpoints', help="where to save trained checkpoints during training")
...
parser.add_argument("--resume_from", type=str, default="/home/oip/file/lyj/checkpoints/testrun_baseline_epoch8_checkpoint.pth", help="Path to checkpoint directory (without _lora/_non_lora suffix)")
